...
public class MorseCode {
    ...
    public  HashMap<String, String> ALPHA_TO_MORSE = new HashMap<>();
    public  HashMap<String, String> MORSE_TO_ALPHA = new HashMap<>();
    ...
    public String alphaToMorse(String englishCode) {
        StringBuilder builder = new StringBuilder();
